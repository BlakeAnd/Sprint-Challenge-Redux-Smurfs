...
actions send information about changes and events in the application to the reducer. reducers interpret the input and change the state of the app accordingly. the store is a data structure that holds all the state data of your application. 

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

application state means having the state for the whole application stored in one place. component state is storing that tha state of a part of the application within that part and passing it as props when needed. it becomes more useful to switch to redux/application style state management on larger projects as it provides a way to organize our files.  

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

thunk allows us to work asynchronously in redux. it allows our action creators to call upon a function intead of just a s imple action. 
